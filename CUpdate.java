...
public class CUpdate extends JFrame implements ActionListener
{
	...
	public CUpdate(String userId)
	{
		...
		emailIdLabel.setBounds(350, 360, 150, 40);
		...
		emailText.setBounds(600, 360, 250, 40);
	...
	public void updateInDB()
	{
		...
		String query = "UPDATE userinfo SET username='"+cName+"', phoneNumber = '"+phnNo+"',  emailId = '"+email+"' WHERE userid='"+newId+"'";	
        Connection con=null;//for connection
        Statement st = null;//for query execution
		System.out.println(query);
        try
